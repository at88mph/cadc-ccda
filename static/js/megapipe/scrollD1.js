...
var CTypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.2008B.IQ.x"+x+".y"+y+".z"+z+".jpg"
...
var ICTypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.spitzer.irac.colour.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var MCTypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.spitzer.mips.colour.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var UTypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/CFHTSG/D1U.2007A.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var GTypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/CFHTSG/D1G.2007A.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var RTypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/CFHTSG/D1R.2007A.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var ITypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/CFHTSG/D1I.2007A.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var ZTypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/CFHTSG/D1Z.2007A.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var I1TypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.spitzer.ch1.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var I2TypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.spitzer.ch2.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var I3TypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.spitzer.ch3.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var I4TypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.spitzer.ch4.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var M1TypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.spitzer.mips24.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var M2TypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.spitzer.mips70.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
var M3TypeOptions = {
  getTileUrl: function(coord, zoom) {
    ...
    var y=normalizedCoord.y;
    var z=zoom;
    var url="https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/data/pub/GSKY/D1.spitzer.mips160.x"+x+".y"+y+".z"+z+".jpg"
    //document.getElementById("diag").innerHTML = url;
    return url;
...
function initialize() {
  ...
  // ** set map options
  var mapOptions = {
    center: new google.maps.LatLng(85.049825445937,-179.86404418945312),
    zoom: 17,
    streetViewControl:false,
    mapTypeControlOptions: {
      mapTypeIds: ["CFHT_Col","IRAC_Col","MIPS_Col","CFHT_u","CFHT_g","CFHT_r","CFHT_i","CFHT_z","IRAC1_3.6um","IRAC2_4.5um","IRAC3_5.8um","IRAC4_8.0um","MIPS_24um","MIPS_70um","MIPS_160um"],
...
map.mapTypes.set('MIPS_160um', M3MapType);
  ...
  function getvs() {
    ...
    if (xcen>0 && ycen>0 && xcen<xmax && ycen<ymax) {
      ...
      var url=url+'D1.'+filter+'.fits'+section;
